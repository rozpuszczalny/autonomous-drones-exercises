...
sequences_square = [
    ...
    (10.0, 0.0, 10.0, 0.0, 90.0),
    (10.0, -10.0, 0.0, 0.0, 180.0),
    (10.0, 0.0, -10.0, 0.0, 270.0),
    # Land
...
sequences_triangle = [
    ...
    (10.0, -5.0, 8.66025404, 0.0, 120.0),
    (10.0, -5.0, -8.66025404, 0.0, 240.0),
    # Land
    (30.0, 0.0, 0.0, 10.0, 0.0),
]
...
async def manual_controls(sequences):
    ...
    await drone.offboard.set_velocity_ned(offboard.VelocityNedYaw(north, east, down, yaw))
